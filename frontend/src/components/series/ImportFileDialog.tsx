...
export default function ImportFileDialog({ isOpen, onClose, onSuccess }: ImportFileDialogProps) {
    ...
    const handleFileSelect = useCallback((selectedFile: File) => {
        ...
        if (ext !== 'txt' && ext !== 'md') {
            setError(t("importFile.invalidType"));
            return;
        }
                ...
                >
                    ...
                    >
                        ...
                        <div className="flex items-center justify-between mb-6">
                            <h2 className="text-2xl font-display font-bold text-white">{t("importFile.title")}</h2>
                            <button
                                onClick={handleClose}
                                ...
                                <div className="space-y-4">
                                    ...
                                    >
                                        ...
                                        {file ? (
                                            ...
                                            <>
                                                ...
                                                <p className="text-gray-500 text-sm">{t("importFile.supportHint")}</p>
                                            </>
                                        )}
                                    </div>
                                    ...
                                    <div>
                                        <label className="block text-sm font-medium text-gray-300 mb-2">
                                            {t("importFile.seriesTitle")} <span className="text-red-400">*</span>
                                        </label>
                                        <input
                                            type="text"
                                            value={seriesTitle}
                                    ...
                                    <div>
                                        <label className="block text-sm font-medium text-gray-300 mb-2">
                                            {t("importFile.descriptionOptional")}
                                        </label>
                                        <textarea
                                            value={description}
                            ...
                            {step === 2 && previewResult && (
                                <div className="space-y-4">
                                    <p className="text-gray-400 text-sm">
                                        {t("importFile.previewHint", { count: previewResult.episodes.length })}
                                    </p>
                            ...
                            {step === 3 && createdResult && (
                                <div className="flex flex-col items-center justify-center py-8 space-y-6">
                                    ...
                                    <div className="text-center">
                                        <h3 className="text-xl font-bold text-white mb-2">{t("importFile.createdTitle")}</h3>
                                        <p className="text-gray-400">
                                            {t("importFile.createdHint", { title: seriesTitle, count: createdResult.episode_count })}
                                        </p>
                                    </div>
                                    <button
